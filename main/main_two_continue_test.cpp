...
int main()
{
	...
	dx0=4.0*R; dy0=sqrt(1-0.75*0.75)*R; dz0=0.75*R;
	...
	foutdz.open("./result/result_particle_show_dxdz.txt",ios::app);
	...
	fout_particle_alltime.open("./result/particle/result_particle_alltime.txt",ios::app);

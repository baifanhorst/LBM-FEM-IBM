...
void particle::output_vtk_multiple(int i_cell)
{
	ofstream outfile;
	char name[]="./result/vtk/result_particle_x.vtk";
	char x='0'+i_cell;
	name[25]=x;
	outfile.open(name,ios::out); //这个路径是a.out所在当前目录下的result文件夹，不是本函数所在当前路径下的result
